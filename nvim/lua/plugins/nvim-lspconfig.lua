...
local servers = { 'bashls', 'pyright', 'clangd', 'cmake', 'html', 'tsserver' , 'gopls', 'rust_analyzer'}
...
require'lspconfig'.tsserver.setup{
    ...
    filetypes = { "javascript", "javascriptreact", "javascript.jsx", "typescript", "typescriptreact", "typescript.tsx",".css" },
    capabilities = capabilities,
}

require'lspconfig'.clangd.setup{
  filetypes = { "cpp", "cpp.cpp", "c++", ".c++", "c" },
  capabilities = capabilities,
}
