...
execute 'source ' . s:path . '/' . 'YouCompleteMe_options.vim'
...
if exists('*minpac#init')
    ...
    call minpac#add('tibabit/vim-templates')          " File templates

    " Vim 8
    "call minpac#add('lifepillar/vim-mucomplete')       " Builtin chainable autocomplete
    call minpac#add('Valloric/YouCompleteMe')           " Code Autocomplete
